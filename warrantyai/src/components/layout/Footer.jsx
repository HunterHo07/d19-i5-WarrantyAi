  ...
  const footerLinks = [
    {
      title: 'Product',
      links: [
        { name: 'Features', path: '/showcase' },
        { name: 'Demo', path: '/demo' },
        { name: 'Roadmap', path: '/roadmap' },
        { name: 'Pricing', path: '/landing' },
      ],
    },
    {
      title: 'Company',
      links: [
        ...
        { name: 'Careers', path: '/landing' },
        { name: 'Contact', path: '/landing' },
      ],
    },
    {
      title: 'Resources',
      links: [
        { name: 'Blog', path: '/landing' },
        { name: 'Support', path: '/landing' },
        { name: 'Documentation', path: '/landing' },
        { name: 'Privacy Policy', path: '/landing' },
      ],
    },
  ];
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
              Smart warranty assistant that automatically tracks, manages, and reminds you of product warranties.
            </p>
